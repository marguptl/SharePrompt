  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
        {type} and share creative prompts with the world and let your creative ideas go wild with AI-powered platform.
      </p>
      ...
      <label >
          <span className="font-satoshi font-semibold text-base text-grey-700">
            Tag{' '}
            <span className="font-normal">(#product, #webDeveloper , #design ) </span>
          </span>
